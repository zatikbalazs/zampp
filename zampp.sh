...
printf "║   ███████████ █████   █████ █████     █████ █████        █████         ║\n"
printf "║  ░░░░░░░░░░░ ░░░░░   ░░░░░ ░░░░░     ░░░░░ ░░░░░        ░░░░░          ║\n"
printf "║  ${CYAN}ZAMPP STACK v1.0.1                  www.github.com/zatikbalazs/zampp${RESET}  ║\n"
printf "╚════════════════════════════════════════════════════════════════════════╝\n"

printf "\n"

printf "The ZAMPP stack:\n"
printf "~~~~~~~~~~~~~~~~\n"
...
printf "~~~~~~~~~~~~~~~\n"
[[ $STACK == 0 ]] && printf "${CYAN}${UNDERLINE}I${RESET}${CYAN}nstall${RESET}  Install the ZAMPP stack.\n"
[[ $STACK == 1 ]] && printf "${CYAN}${UNDERLINE}U${RESET}${CYAN}pdate${RESET}   Update all packages.\n"
[[ $STACK == 1 ]] && printf "${CYAN}${UNDERLINE}R${RESET}${CYAN}estart${RESET}  Restart all ZAMPP stack services.\n"
[[ $STACK == 1 ]] && printf "${CYAN}${UNDERLINE}S${RESET}${CYAN}top${RESET}     Stop all ZAMPP stack services.\n"
[[ $STACK == 1 ]] && printf "${CYAN}DELETE${RESET}   Delete the entire ZAMPP stack.\n"
